I model data and ship Python systems that people actually use.

**EPL Tutors** is a live GCSE/A-level science platform I designed, built, and operate for my own students: syllabus knowledge graph, append-only mastery ledger, homework kept separate from mastery. Product source is private. Public write-up: [epltutors-architecture-showcase](https://github.com/Salama-Khan/epltutors-architecture-showcase). Site: [epltutors.com](https://epltutors.com).
